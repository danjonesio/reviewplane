...
const PATTERN_18 = new RegExp("^[^\\s\\x00-\\x1f]+$", "u");
const PATTERN_19 = new RegExp("^[a-z][a-z0-9_]*$", "u");
const PATTERN_20 = new RegExp("^[A-Za-z0-9][A-Za-z0-9.-]*$", "u");
const PATTERN_21 = new RegExp("^[a-z][a-z0-9_]{0,62}$", "u");
const PATTERN_22 = new RegExp("^[0-9]{4}_[a-z0-9_]+\\.sql$", "u");
const PATTERN_23 = new RegExp("^[A-Za-z0-9:._/-]+$", "u");
const PATTERN_24 = new RegExp("^[^\\x00]+$", "u");
const PATTERN_25 = new RegExp("^[A-Za-z0-9_.-]+$", "u");
const PATTERN_26 = new RegExp("^[a-z][a-z0-9_.]*$", "u");
const PATTERN_27 = new RegExp("^[a-z][a-z0-9_.\\[\\]]*$", "u");
...
export function validateRepositoryIdentityCloneUrlsItem(value: unknown, path: string, out: SchemaViolation[]): void {
  checkString(value, path, out, { minLength: 3, maxLength: 512, pattern: PATTERN_18 });
}
...
export function validateBackupSourceHostname(value: unknown, path: string, out: SchemaViolation[]): void {
  checkString(value, path, out, { minLength: 1, maxLength: 253, pattern: PATTERN_20 });
}
...
export function validateBackupTableName(value: unknown, path: string, out: SchemaViolation[]): void {
  checkString(value, path, out, { minLength: 1, maxLength: 63, pattern: PATTERN_21 });
}
...
export function validateBackupManifestSchemaVersion(value: unknown, path: string, out: SchemaViolation[]): void {
  checkString(value, path, out, { minLength: 5, maxLength: 128, pattern: PATTERN_22 });
}
...
export function validateBackupManifestKeyReferencesItem(value: unknown, path: string, out: SchemaViolation[]): void {
  checkString(value, path, out, { minLength: 1, maxLength: 256, pattern: PATTERN_23 });
}
...
export function validateStreamErrorMessage(value: unknown, path: string, out: SchemaViolation[]): void {
  checkString(value, path, out, { minLength: 1, maxLength: 1024, pattern: PATTERN_24 });
}
...
export function validateApiErrorDetailsAllowedTransitionsItem(value: unknown, path: string, out: SchemaViolation[]): void {
  checkString(value, path, out, { minLength: 1, maxLength: 64, pattern: PATTERN_25 });
}
...
export function validateApiErrorDetailsField(value: unknown, path: string, out: SchemaViolation[]): void {
  checkString(value, path, out, { minLength: 1, maxLength: 128, pattern: PATTERN_27 });
}
...
export function validateCursorClaimsSortKey(value: unknown, path: string, out: SchemaViolation[]): void {
  checkString(value, path, out, { minLength: 1, maxLength: 128, pattern: PATTERN_24 });
}
