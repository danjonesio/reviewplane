...
export async function truncateAll(pool: Pool): Promise<void> {
  await pool.query(
    "TRUNCATE idempotency_keys, verification_artefacts, verifications, comments, annotations, findings, reviews, artefact_access_grants, artefacts, control_leases, browser_sessions, browser_worker_projects, browser_workers, events, agent_sessions, agent_credentials, workspaces, viewer_sessions, projects, organisations RESTART IDENTITY CASCADE",
  );
}
